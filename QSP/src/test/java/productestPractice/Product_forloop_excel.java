...
public class Product_forloop_excel {
...
//				WebDriver driver = new ChromeDriver(settings);
		...
		FileInputStream fs1 = new FileInputStream("./resources/testDataforloopTowrite.xlsx");
//		FileInputStream fs1 = new FileInputStream("./resources/testDataforloopTowrite-2.xlsx");//write message
		...
		FileOutputStream fso = new FileOutputStream("./resources/testDataforloopTowrite-2.xlsx");
		wb.write(fso);
		wb.close();
		*/
	}
