...
public class P_2 {
	...
	public static void main(String[] args) throws Throwable {
		...
		FileReader reader = new FileReader("./src/test/resources/comData.json");
		JSONObject obj = (JSONObject) parser.parse(reader);

		String BROWSER1 = (String) obj.get("browser");

		if (URL == null) {
		    throw new RuntimeException("URL is missing from comData.properties");
		}

	
		//Properties file
				//1.Get the java representation object of physical file
				FileInputStream fs = new FileInputStream("./src/test/resources/comData.json");
